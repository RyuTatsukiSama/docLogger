...
#include "EM_TestInteractiveTool.generated.h"


/**
 * Builder for UEM_TestInteractiveTool
 */
UCLASS()
class EM_TEST_API UEM_TestInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UEM_TestInteractiveTool
 */
UCLASS(Transient)
class EM_TEST_API UEM_TestInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UEM_TestInteractiveToolProperties();
...
/**
 * UEM_TestInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class EM_TEST_API UEM_TestInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UEM_TestInteractiveToolProperties> Properties;
